...
### ImplTypeCheck.Sample

A project that references the sample analyzers. Note the parameters of `ProjectReference`
in [ImplTypeCheck.Sample.csproj](../ImplTypeCheck.Sample/ImplTypeCheck.Sample.csproj), they make sure that the project
is referenced as a set of analyzers.
