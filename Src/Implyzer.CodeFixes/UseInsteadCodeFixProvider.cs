...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(UseInsteadCodeFixProvider))]
[Shared]
public class UseInsteadCodeFixProvider : CodeFixProvider {
    ...
    public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context) {
        ...
        context.RegisterCodeFix(
            CodeAction.Create(
                title,
                c => ReplaceAsync(context.Document, diagnostic.Location.SourceSpan, replacement!, c),
                title
            ),
            diagnostic
        );
